...
export default {
	...
	Java_org_lwjgl_opengl_GL11_nglClearDepth(lib, a, funcPtr)
	{
		checkNoList(curList);
		mcCtx.clearDepth(a);
	},
	Java_org_lwjgl_opengl_GL11_nglDepthFunc(lib, a, funcPtr)
	{
		checkNoList(curList);
		mcCtx.depthFunc(a);
	},
	Java_org_lwjgl_opengl_GL11_nglCullFace(lib, mode, funcPtr)
	{
		checkNoList(curList);
		mcCtx.cullFace(mode);
	},
	...
	Java_org_lwjgl_opengl_GL11_nglDepthMask(lib, a, funcPtr)
	{
		checkNoList(curList);
		mcCtx.depthMask(a);
	},
	...
	Java_org_lwjgl_opengl_GL11_nglNormalPointer(lib, type, stride, memPtr, funcPtr)
	{
		normalData.size = 3;
	...
	Java_org_lwjgl_opengl_GL11_nglBegin(lib, mode, funcPtr)
	{
		checkNoList(curList);
	...
	Java_org_lwjgl_opengl_GL11_nglTexCoord2f(lib, x, y, funcPtr)
	{
		checkNoList(curList);
	...
	Java_org_lwjgl_opengl_GL11_nglVertex3f(lib, x, y, z, funcPtr)
	{
		checkNoList(curList);
	...
	Java_org_lwjgl_opengl_GL11_nglEnd(lib, funcPtr)
	{
		checkNoList(curList);
		// Upload vertex data
	...
	async Java_org_lwjgl_opengl_LinuxEvent_nGetKeyAddress(lib, buffer)
	{
	...
	async Java_org_lwjgl_opengl_LinuxEvent_nGetKeyType(lib, buffer)
	{
		// Same as type, apparently
		var bufferAddr = Number(await buffer.address());
		var v = lib.getJNIDataView();
	...
	async Java_org_lwjgl_opengl_LinuxEvent_nGetKeyKeyCode(lib, buffer)
	{
		var bufferAddr = Number(await buffer.address());
		var v = lib.getJNIDataView();
		return v.getInt32(4, true);
	...
	Java_org_lwjgl_opengl_LinuxKeyboard_lookupKeysym(lib, eventPtr, index)
	{
		return Number(eventPtr);
	},
	async Java_org_lwjgl_opengl_LinuxKeyboard_lookupString(lib, eventPtr, buffer)
	{
