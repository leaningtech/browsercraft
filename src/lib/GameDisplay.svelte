...
<div class="game-container">
	...
	<div id="intro" class="intro">
		...
		{#if !eulaAccepted}
			<p>
				...
				Before playing, you have to accept the
	...
	<div id="timeout-info" class="timeout-info">
		...
		<p>Thanks for playing this CheerpJ demo.</p>
		<p>
			<a href="https://cheerpj.com" target="_blank">CheerpJ</a> is a WebAssembly JVM for the browser
			that can run any Java application, applet and library in the browser. Java 8, 11 and 17 are
			currently supported. Advanced features such as multithreading, reflection and custom
			classloaders are also fully supported, for more information you can join our
			<a href="https://discord.gg/7xXW6NAdHT" target="_blank">Discord</a>.
		</p>
		<p>
			Want to support us? Star Browsercraft on <a
				href="https://github.com/leaningtech/browsercraft"
