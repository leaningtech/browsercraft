<script lang="ts">
	...
	async function startGame() {
		...
		const url = "https://piston-data.mojang.com/v1/objects/4a2fac7504182a97dcbcd7560c6392d7c8139928/client.jar";
		await mc.downloadFileToCheerpJ(url, (downloadedBytes: number, totalBytes: number) => {
...
<div class="container">
	<div class="loading" id="loading">
		<img src={spinnerWhite} class="w-5px h-5px" alt="Loading" />
		<p>Loading CheerpJ ...</p>
	</div>
	...
	<div class="timeout-info" id="timeout-info" style="display: none">
		<h1>DEMO TIMEOUT</h1>
		<p>
	...
	<div class="timeout-timer" id="timeout-timer" style="display: none">
